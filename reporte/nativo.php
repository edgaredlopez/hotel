...
$operacion = ProcesoData::getById($_GET['id']);
	...
	if('1' == '1')
	{
		...
		$pdf->Text(3.8, $get_YH + 19, 'NRO FACTURA : '.$operacion->nro_folio);
		...
		$pdf->MultiCell(68, 4.2, 'RFC: '.$operacion->getCliente()->giro, 0,'L',0 ,1);
		$pdf->SetXY(3.8,$get_YH + 34);
		$pdf->MultiCell(68, 4.2, 'Telefono: '.$operacion->getCliente()->estado_civil, 0,'L',0 ,1);
		$pdf->SetXY(3.8,$get_YH + 38);
		$pdf->MultiCell(68, 4.2, 'Razon social: '.$operacion->getCliente()->nacionalidad, 0,'L',0 ,1);
		...
		$pdf->MultiCell(68, 4.2, 'E-mail: '.$operacion->getCliente()->destino, 0,'L',0 ,1);
