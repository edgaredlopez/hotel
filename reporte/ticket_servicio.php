...
$operacion = VentaData::getById($_GET['id']);
	...
	if('1' == '1')
	{
		...
		$pdf->MultiCell(68, 4.2, 'Nombre: '.$operacion->getProveedor()->nombre, 0,'L',0 ,1);
		$pdf->SetXY(3.8,$get_YH + 26);
		$pdf->MultiCell(68, 4.2, 'Documento: '.$operacion->getProveedor()->documento, 0,'L',0 ,1);
		$pdf->SetXY(3.8,$get_YH + 30);
		$pdf->MultiCell(68, 4.2, 'Domicilio: '.$operacion->getProveedor()->direccion, 0,'L',0 ,1);
