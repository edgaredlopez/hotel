...
<table class="table table-bordered table-hover">
    ...
    <tr>
        <td>INGRESOS:</td>
        <td>Q   <?php echo number_format($ingreso,2,'.',',');?></td>
    </tr>
    <tr>
        <td>EGRESOS:</td>
    ...
    <tr>
        <td>NETO:</td>
        <td>Q    <?php echo number_format($ingreso-$egreso,2,'.',','); ?></td>
    </tr>
</table>
...
?>
    ...
    case 6: echo "Sábado".', '.$numero1.' de '.$mes; break;
}; ?>
                </td>
                <td style="width: 40%;">
                    ...
                    if(@count($boletas)>0){
                        ...
                        Q    <?php echo number_format($subcero+$cero,2,'.',','); ?>
 ...
 ?>
                        Q    <?php echo number_format($cero1+$cero101+$cero102,2,'.',','); ?>
