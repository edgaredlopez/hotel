...
<page backtop="15mm" backbottom="28mm" backleft="5mm" backright="5mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; border: solid 0px #7f8c8d; text-align: center; font-size: 10pt;padding:1mm; padding-top: 0mm !important;">
        <tr >
            ...
            <th class="pumpkin" style="width: 40%; border: black 1px solid">REPORTE  CAJA</th>
        ...
        <tr>
            ...
            <td  style="width: 40%; text-align: center;border:black 1px solid;"><br><b style="text-decoration:underline; font-family:Arial, Helvetica, sans-serif;" >FECHA: <?php echo $hoy; ?><BR><BR> Alquiler de habitación: <?php echo 'S/   '.number_format($subtotal4,2,'.',',') ?><BR><BR> Servicio de habitación: <?php echo number_format($subtotal3,2,'.',','); ?><BR><BR> Gastos: <?php echo 'S/  '.number_format($subtotal5,2,'.',','); ?><BR><BR> TOTAL: <?php echo 'S/   '.number_format($subtotal3+$subtotal4-$subtotal5,2,'.',','); ?></b></td>
...
<table  class="contenido">
            ...
            <td><b>S/  <?php echo number_format($reportediario->precio,2,'.',','); ?></b></td>
            <td ><b>S/  <?php echo number_format($reportediario->cant_noche,2,'.',','); ?></b></td>
            <?php $subtotal= ($reportediario->precio*$reportediario->cant_noche)+$reportediario->total; ?>
...
<?php $total=$subtotal+$total; ?>
            ...
            <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 30%;float: right !important;">S/  <?php echo number_format($total,2,'.',','); ?> </th>
                        <th style="width: 20%;"></th>
                        <th style="width: 20%;"> </th> 
            </tr>
<?php 
...
<table  class="contenido">
        ...
        <?php $reporproducts = ProcesoVentaData::getIngresoCaja($id_caja);
            ...
            <td >S/  <?php echo   number_format($reporproduct->precio,2,'.',','); ?><br /></td>
            <?php $subtotal1=$reporproduct->cantidad*$reporproduct->precio; ?>
            <td><b>S/    <?php echo number_format($subtotal1,2,'.',','); ?></b></td>
...
<?php $subtotal2=$subtotal1+$subtotal2; ?>
            ...
            <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 20%;">S/ <?php echo   number_format($subtotal2,2,'.',','); ?></th>
