...
$producto= TmpData::getByIdProductoSession($_POST['id'],$session_id);
if(@count($producto)>0){
	...
	$del->del();
		...
		$tmps = TmpData::getAllTemporalCompra($session_id);
			...
			foreach($tmps as $tmp): ?> 
                ...
                <td>Q  <?php echo number_format($tmp->precio_tmp,2,'.',','); ?></td>
            ...
            <tr style="background-color: #f3f3f3;">
                ...
                <td><span class="pull-left"><?php echo 'Q   '.number_format(($sumador_total/1.18),2,'.',',');?></span></td>
                <td></td>
            </tr>
            <tr style="background-color: #f3f3f3;">
                <td colspan=4><span class="pull-right">IVA </span></td>
                <td><span class="pull-left"><?php echo 'Q   '.number_format($sumador_total-($sumador_total/1.18),2,'.',',');?></span></td>
                <td></td>
            </tr>
