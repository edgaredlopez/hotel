	...
	$del->del();
		...
		$tmps = TmpData::getAllTemporal($session_id);
            ...
            <tr style="background-color: #f3f3f3;">
                ...
                <td><span class="pull-left"><?php echo 'Q   '.number_format($sumador_total*$iva_sp,2,'.',',');?></span></td>
                <td></td>
            </tr>
            <tr style="background-color: #e4e4e4;">
                <td colspan=4><span class="pull-right">TOTAL </span></td>
                <td><span class="pull-left"><?php echo 'Q   '.number_format($sumador_total+($sumador_total*$iva_sp),2,'.',',');?></span></td>
                <td></td>
            </tr>
            <?php }; ?>