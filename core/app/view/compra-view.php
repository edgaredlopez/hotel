							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<select  data-placeholder="..."  name="contado" id="contado" 
											class="form-control" onChange="pagoOnChange(this)">
								...
								<div class="row" id="idpago" style="display:none;">
									...
									<div class="col-sm-6"> 
										<label>Nro de días crédito</label> 
										<input type="text" name="nro_credito" placeholder="15"
										 	class="form-control"
                                			onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')">
									</div>
