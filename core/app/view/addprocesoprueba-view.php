                        ...
                        <div class="col-md-7 b-r">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr style="background-color: #f5f5f5;">
                                    ...
                                    <td><?php echo $habitacion->cant_noche; ?></td>
                                    <td><?php echo $habitacion->getHabitacion()->nombre; ?></td>
                                    <td><b class="pull-right">$   <?php echo number_format($habitacion->precio,2,'.',','); ?></b></td>
                                </tr>
                                <?php $sumatoria_s=0; ?>
                                  ...
                                  foreach($tmps as $p):  ?>
                                        <tr>
                                          ...
                                          <td><a href="#"  data-toggle="modal" data-target="#confirmare<?php echo $p->id; ?>" data-options="splash-2 splash-ef-11" class="tex-danger btn-xs b-0" style="color:#e05d6f;"><i class="glyphicon glyphicon-trash"></i></a></td>
                                              ...
                                              <div class="modal-content">
                                                <div class="modal-header"> 
                                                 ...
                                                 <div class="modal-footer">
                                                    <a href="index.php?view=delestadiap&id=<?php echo $p->id; ?>&id_p=<?php echo $_GET['id']; ?>" class="btn btn-success btn-ef btn-ef-3 btn-ef-3c"><i class="fa fa-arrow-right"></i> Eliminar</a>
                            ...
                            <p class="pull-right">Sub-total
                                <?php $total_s=($habitacion->precio*$habitacion->cant_noche)+$sumatoria_s; ?>
                ...
                <div class="modal-body">
                    ...
                    <div id="hora_fecha">
                     <div class="form-group"> 
                        ...
                        <div class="col-md-7">  
                           <input type="number" name="cant_noche" required class="form-control validanumericos" placeholder="Ejem. 1 Noche" >   
                        </div>
                      </div>
