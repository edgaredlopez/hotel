          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="index.php?view=historial_habitacion&id=<?php echo $habitacion->id; ?>"   class="btn btn-outline btn-info "> Historial de mantenimiento</a>
 
                <button type="submit" class="btn btn-outline btn-warning "> Pasar a mantenimiento</button>
