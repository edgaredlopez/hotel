...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE POR RANGO DE CAMBIO DE HABITACIÓN
        <small>Avance</small>
      </h3> 
      <ol class="breadcrumb">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content"> 
              <div class="tab-pane active" id="tab_1"> 
                <?php $reportediarios = ProcesoData::getIngresoRangoFechasNew($_POST['start'],$_POST['end']);
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                   ...
                   <?php $numero=$numero+1;?>
                      <tr>
                        ...
                        <td><?php echo $reportediario->getHabitacionNew()->nombre; ?></td>
