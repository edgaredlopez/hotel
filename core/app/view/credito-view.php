...
<section class="content-header">
    <ol class="breadcrumb">
      <li><a href="index.php?view=reserva"><i class="fa fa-home"></i> Inicio</a></li>
        ...
        <li class="active">Histórico de pago del crédito</li>
    </ol>
</section> 
</div> 
  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>HISTÓRICO DE PAGO</strong> DEL CRÉDITO</h1>
        <ul class="controls">
      ...
      <div class="tile-body">
        <div class="form-group">
          ...
          <input id="filter" type="text" class="form-control input-sm w-sm mb-12 inline-block"/>
              ...
              <?php $procesos = ProcesoData::getProcesoCredito();
                if(@count($procesos)>0){
                  // si hay procesos
                  ?>
                    ...
                    <div class="modal-dialog modal-warning">
                      <div class="modal-dialog">
                        <div class="modal-content">
                            <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addpagocredito" role="form">
                            ...
                            <div class="col-md-offset-1 col-md-10">
                              ...
                              <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control col-md-8" name="monto" value="<?php echo $subtotal; ?>" required placeholder="Ingrese monto">
                                </div>
                              </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <input type="hidden" class="form-control" name="id_proceso" value="<?php echo $reportediario->id; ?>" >
