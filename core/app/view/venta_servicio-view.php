         ...
         <div class="col-sm-6 col-md-8">
            ...
            <div class="panel panel-default" id="panel-detalle">
              ...
              <div class="panel-heading">
                <h6 class="panel-title">Detalle de Venta de Servicio</h6>
              </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">
                        <span class="glyphicon glyphicon-plus"></span> Agregar servicios a venta
                      </button>
                                        </div>
                    </div>
                  </div>
...
<!-- tile -->
    ...
    padding: 20px 15px !important;">
                                ...
                                <!-- tile body -->
                                <div class="tile-body">
                                    <form  autocomplete="off"  method="post" action="index.php?view=addventa_servicio">
            ...
            <div id="tipo_cliente">
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6"> 
                    <label>Número de casillero</label>
                    <input type="text" id="nro_casillero" name="nro_casillero" placeholder="Ejem. 12"
                       class="form-control"  >      
                  </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <select  name="id_tipo_comprobante" class="form-control"  >
...
<!-- /page container -->
  ...
  <script> 
    ...
    function load(page){
      ...
      $.ajax({ 
        type: "POST",
        url:'./?action=buscar_producto_sauna', 
        data: parametros, 
