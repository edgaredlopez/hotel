                                                ...
                                                <section class="tile tile-simple bg-tr-black lter">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                           <?php $final= $total+(($operacion->precio*$operacion->cant_noche)+$operacion->total+$operacion->extra);?>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Subtotal:</strong> $   <?php echo number_format(($final/1.19),2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">IVA:</strong>  $   <?php echo number_format($final-($final/1.19),2,'.',','); ?></li>
