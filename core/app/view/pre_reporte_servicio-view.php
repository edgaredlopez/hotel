...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE POR RANGO DE FECHA DEL SERVICIO
        <small>Avance</small>
      </h3> 
      <ol class="breadcrumb">
...
<form method="post" action="index.php?view=report_servicio" >
                                <div class="tile-body">
                                    ...
                                    <h4 class="custom-font"><strong>Selecciona</strong> Servicio</h4>
                                    <select class="form-control select2" required  name="id_producto"> 
                                    <option value="">--- Selecciona ---</option>  
                                      <?php $productos = ProductoData::getAllServicio();?>
