...
$id_varios=$_POST["id"];
 ...
 for ($i=0;$i<count($id_varios);$i++)    
{  
$id_varioaa=$id_varios[$i];
};
...
?>
 ...
 <?php $operacion = ProcesoData::getById($id_varioaa);
            ...
            <section id="content">
                ...
                <div class="page page-shop-single-order">
                    ...
                    <div class="pageheader">
                        ...
                        <h2><?php echo $operacion->getComprobante()->nombre; ?> <span>Imprimir</span></h2>
                                                        ...
                                                        <div class="table-responsive">
                                                             <table class="table table-hover table-striped">
                                                                ...
                                                                <tbody>
																	...
																	<?php
																	$totaaal=number_format((ProcesoData::getById($id_varios[$i])->precio*ProcesoData::getById($id_varios[$i])->cant_noche)+ProcesoData::getById($id_varios[$i])->total+ProcesoData::getById($id_varios[$i])->extra,2,'.',',')+$totaaal;
																	};
																	?>
