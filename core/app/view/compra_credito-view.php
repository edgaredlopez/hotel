...
<section class="content-header">
    <ol class="breadcrumb">
      <li><a href="index.php?view=reserva"><i class="fa fa-home"></i> Inicio</a></li>
        ...
        <li class="active">Histórico de compras a crédito</li>
    </ol>
</section> 
</div> 
  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>HISTÓRICO DE COMPRAS</strong> A CRÉDITO</h1>
        <ul class="controls">
      ...
      <div class="tile-body">
        <div class="form-group">
          ...
          <input id="filter" type="text" class="form-control input-sm w-sm mb-12 inline-block"/>
              ...
              <?php $procesos = VentaData::getAllCredito();
                if(@count($procesos)>0){
                  // si hay procesos
                  ?>
                  ...
                  <tbody>
                   ...
                   <?php $numero=$numero+1;?>
                      <tr>
                        ...
                        <td><?php echo $reportediario->getProveedor()->razon_social; ?></td>
                        <td><?php echo $reportediario->getProveedor()->nombre; ?></td>

                        


                        <td><?php echo $reportediario->nro_credito." Días"; ?></td>
                    ...
                    <div class="modal-dialog modal-warning">
                      <div class="modal-dialog">
                        <div class="modal-content">  
                            <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addpagocompracredito" role="form">
