...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE RANGO DE FECHAS: SERVICIOS 
        <small>Avance</small>
      </h3> 
      <ol class="breadcrumb">
        <li><a href="index.php?view=reserva"><i class="fa fa-home"></i> Inicio</a></li>
        <li><a href="#">Reportes</a></li>
        <li class="active">Reporte servicios</li>
      </ol>
</section>
</div>
              ...
              <div class="box-body" style="text-align: left;">
                ...
                <table>
                  ...
                  <tr>
                      ...
                      <td><h5 class="control-label text-red"><?php echo $producto->nombre; ?></h5></td>
                  </tr>
  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" style="background-color: #d2d6de;">
              ...
              <li class="active"><a href="#tab_2" data-toggle="tab">Venta de servicios</a></li>
              ...
              <div class="tab-pane active" id="tab_2">
                ...
                if(@count($reporproducts)>0){
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                   ...
                   <?php $numero=$numero+1;?>
                   <?php if($reporproduct->fecha_creada!=NULL and $reporproduct->getProducto()->id_categoriap!=NULL){ ?>
                      <tr>
