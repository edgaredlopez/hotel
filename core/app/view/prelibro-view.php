...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> GENERAR LIBRO DE FACTURAS POR FECHA
        <small>Avance</small>
      </h3> 
      <ol class="breadcrumb">
...
<form method="post" action="index.php?view=libro" >
                                <div class="tile-body">
                                ...
                                <div class="tile-footer">
                                    <div class="form-group text-center">
                                        ...
                                        <button class="btn btn-rounded btn-success ripple" type="submit"><i class="fa fa-open-eye"></i> Ver libro</button>
                                    </div>
                                </div>
                            </form>
