...
<div class="row">
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="reporteExcel/reporte_rango.php?start=<?php echo $_POST['start']; ?>&end=<?php echo $_POST['end']; ?>" class="text-muted"><i class="fa fa-print"></i> DESCARGAR EXCEL</a></li>
      </ol>
</section>
                  ...
                  <tbody >
                   ...
                   <?php $numero=$numero+1;?>
                      <tr>
                        ...
                        <td><?php if($reportediario->getHabitacion()->id_categoria!='' and $reportediario->getHabitacion()->id_categoria!='NULL' and $reportediario->getHabitacion()->id_categoria!='0'){ echo $reportediario->getHabitacion()->getCategoria()->nombre; }else{ echo "-----"; } ?></td>
