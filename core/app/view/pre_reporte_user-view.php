...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE POR RANGO DE FECHA POR USUARIO
        <small>Avance</small>
      </h3> 
      <ol class="breadcrumb">
        <li><a href="index.php?view=reserva"><i class="fa fa-home"></i> Inicio</a></li>
        <li><a href="#">Reportes</a></li>
        <li class="active">Reporte Por rango por usuario</li>
      </ol>
</section>
</div>
...
<form method="post" action="index.php?view=reporte_user" >
                                <div class="tile-body">
                                    ...
                                    <h4 class="custom-font"><strong>Selecciona</strong> Usuario</h4>
