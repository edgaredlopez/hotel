                  ...
                  <thead style="color: white; background-color: #827e7e;">
                   ...
                   <?php foreach($sueldos as $sueldo):?>
                      <tr>
                        ...
                        <td><?php echo $end; ?></td>
                        <td><?php echo $sueldo->getUsuario()->nombre; ?></td> 
                        ...
                        <td>
                        <a href="#"  data-toggle="modal" data-target="#myModal<?php echo $sueldo->id; ?>" class="btn btn-warning btn-xs"><i class="fa fa-money"></i> Editar</a>
                        </td>
                        <td>
                        <a href="index.php?view=delsueldoo&id=<?php echo $sueldo->id; ?>&id_t=<?php echo $sueldo->getUsuario()->id; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> </a>
                        </td>

      <div class="modal fade bs-example-modal-xm" id="myModal<?php echo $sueldo->id; ?>" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-warning">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=update_pagoo" role="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><span class="fa fa-cutlery"></span> EDITAR PAGO</h4>
              </div>
                ...
                <div class="col-md-offset-1 col-md-10">
                   ...
                   <div class="form-group">
                    <div class="input-group">
                      ...
                      <select class="form-control select2" required  name="id_usuario">   
                        <?php $usuarios = PersonaData::getTrabajador();?>
                        <?php foreach($usuarios as $usuario):?> 
                          <option value="<?php echo $usuario->id;?>" <?php if($usuario->id==$sueldo->id_usuario){ echo "selected";} ?> ><?php echo $usuario->nombre;?></option>
                        <?php endforeach;?>
                      </select>  
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" name="monto" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')" required placeholder="Ejem. 1000" value="<?php echo $sueldo->monto;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')"  name="dia_pago" required placeholder="Ejem. 30" value="<?php echo $sueldo->dia_pago;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="date" class="form-control" name="fecha_comienzo" required value="<?php echo $sueldo->fecha_comienzo;?>">
                    </div>
                  </div>
              ...
              <div class="modal-footer">
                ...
                <input type="hidden" class="form-control" value="<?php echo $sueldo->id; ?>" name="id_pago" >
...
<div class="modal fade bs-example-modal-xm" id="myModal" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-success">
          <div class="modal-dialog">
            <div class="modal-content">
              <?php $usuarioos = PersonaData::getAllPago();?>
                ...
                <div class="col-md-offset-1 col-md-10"> 
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Trabajador &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <select class="form-control select2" required  name="id_usuario">   
                        <?php $usuarios = PersonaData::getAllPago();?>
                        <?php foreach($usuarios as $usuario):?> 
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Monto mensual </span>
                      <input type="text" class="form-control col-md-8" name="monto" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')" required placeholder="Ejem. 1000">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Dia de pago &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')" name="dia_pago" required placeholder="Ejem. 30">
                    </div>
                  </div>
             ...
             <?php }else{
                    echo "Necesita agregar mas trabajadores";
                  }?>
