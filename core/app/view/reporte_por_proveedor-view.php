...
<div class="row">
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reporte compras por proveedor</li>
      </ol>
</section>
</div>
...
<h3 >
        <span class="fa fa-file-text-o"></span> REPORTE DE COMPRAS POR PROVEEDOR Y FECHAS SELECCIONADAS
        <small>Avance</small>
      </h3>
          ...
          <div class="box box-success box-solid">
            ...
            <form method="get"  action="" >
              <div class="box-body">
                ...
                <input type="hidden" name="view" value="reporte_por_proveedor">
              ...
              <div class="col-md-3">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon text-green" ><i class="fa fa-calendar"></i> Proveedor</span>
                     <select class="form-control"  name="id_proveedor">
                                <?php $proveedores = PersonaData::getProveedor();?>
                                  <option value="NULL">--- Selecciona ---</option>
                                  <?php foreach($proveedores as $proveedor):?>
                                    <option value="<?php echo $proveedor->id;?>" <?php if(isset($_GET['id_proveedor']) and $_GET['id_proveedor']==$proveedor->id){ echo "selected";} ?> ><?php echo $proveedor->razon_social;?></option>
                                  <?php endforeach;?> 
...
<div class="row">
  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom"> 
                ...
                <?php if(isset($_GET['start']) and $_GET['start']!="" and isset($_GET['end']) and $_GET['end']!=""){
                  $compras = VentaData::getFiltroFechasProveedor($_GET['start'],$_GET['end'],$_GET['id_proveedor']);
                }else{ 
