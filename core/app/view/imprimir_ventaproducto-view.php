                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                ...
                                <span class="controls pull-right">
                                  <a href="index.php?view=lista_venta_producto" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Recepción"><i class="fa fa-times"></i></a>
                                  <!--
                                                            ...
                                                            <?php $productos = ProcesoVentaData::getVenta($operacion->id);
                                                               ...
                                                               <?php foreach($productos as $producto):?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td><b>Q    <?php echo number_format($sub_total,2,'.',','); ?></b></td>
                                                ...
                                                <section class="tile tile-simple bg-tr-black lter">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled" style="background-color: #493d55;color: white;">
                                                            ...
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Efectivo:</strong> Q    <?php echo number_format($operacion->efectivo,2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Tarjeta:</strong>  Q    <?php echo number_format($operacion->tarjeta,2,'.',','); ?></li>
